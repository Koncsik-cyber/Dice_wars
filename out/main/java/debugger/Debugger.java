...
public class Debugger {
    ...
    public void szomszedEllenorzes(PalyaElem[][] palya) {
        ...
        System.out.println("A [0][0] szomsedja jobb: " + palya[0][0].szomszedok[0].szomszedN + "," + palya[0][0].szomszedok[0].szomszedM);
        System.out.println("A [0][0] szomsedja fent: " + palya[0][0].szomszedok[1].szomszedN + "," + palya[0][0].szomszedok[1].szomszedM);
        System.out.println("A [0][0] szomsedja bal: " + palya[0][0].szomszedok[2].szomszedN + "," + palya[0][0].szomszedok[2].szomszedM);
        System.out.println("A [0][0] szomsedja lent: " + palya[0][0].szomszedok[3].szomszedN + "," + palya[0][0].szomszedok[3].szomszedM);
        System.out.println("Létezik a szomszéd? " + palya[0][0].szomszedok[2].letezikASzomszed);
    }
